...
APP_GROUP_PATH="$HOME/Library/Group Containers/group.com.xiongkaiwen.CPAVisualize"
APP_CONTAINER_PATH="$HOME/Library/Containers/com.xiongkaiwen.CPAVisualize"
WIDGET_CONTAINER_PATH="$HOME/Library/Containers/com.xiongkaiwen.CPAVisualize.CPAWidgetExtension"
WIDGET_SCRIPTS_PATH="$HOME/Library/Application Scripts/com.xiongkaiwen.CPAVisualize.CPAWidgetExtension"
HTTP_STORAGE_PATH="$HOME/Library/HTTPStorages/com.xiongkaiwen.CPAVisualize"
SAVED_STATE_PATH="$HOME/Library/Saved Application State/com.xiongkaiwen.CPAVisualize.savedState"
...
CLEAN_PATHS=(
  ...
  "$APP_CONTAINER_PATH/Data/Library/Caches/com.xiongkaiwen.CPAVisualize"
